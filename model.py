...
class CaptioningLSTM(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ImageEncoder(emb_dim=emb_dim, dropout=enc_dropout)
    ...
    def save(self, ckpt_path):
        ...
        torch.save({"model": self.state_dict(), "hp": self._hp}, ckpt_path)
...
class CaptioningLSTMWithLabels(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ImageLabelEncoder(
            num_tokens=num_tokens, emb_dim=emb_dim, dropout=enc_dropout
        )
...
class CaptioningTransformerBase(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ImageEncoder(
            emb_dim=hid_dim, dropout=enc_dropout, spatial_features=False
        )
...
class CaptioningTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ImageEncoder(
            emb_dim=hid_dim, dropout=enc_dropout, spatial_features=True
        )
